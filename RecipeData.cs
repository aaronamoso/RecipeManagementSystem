    ...
    public static class RecipeData
    {
        public static List<Recipe> Recipes { get; } = new List<Recipe>
        {
            new Recipe(
                ...
                30, 10, "4 servings", 400, "Medium", "Dairy-free", "Winter", "Dinner", "Regular"
            ),
            new Recipe(
                ...
                40, 15, "6 servings", 500, "Medium", "Dairy-free", "Any", "Main Course", "Special"
            ),
            new Recipe(
                "Taco Salad", "Aaron A.",
                ...
                0, 15, "2 servings", 400, "Easy", "None", "Summer", "Lunch", "Regular"
            ),
            new Recipe(
                ...
                0, 15, "1 serving", 500, "Easy", "Gluten-free", "Fall", "Snack", "Regular"
            ),
            new Recipe(
                ...
                1, 10, "2 servings", 230, "Easy", "Vegan", "Summer", "Breakfast", "Special"
            ),
            new Recipe(
                ...
                25, 20, "6 servings", 365, "Medium", "Vegetarian", "Winter", "Special", "Special"
            ),
            new Recipe(
                ...
                15, 5, "2 servings", 420, "Medium", "None", "Spring", "Lunch", "Regular"
            ),
            new Recipe(
                ...
                20, 10, "12 servings", 259, "Easy", "Vegetarian", "Spring", "Lunch", "Special"
            ),
            new Recipe(
                ...
                5, 10, "4 servings", 641, "Advanced", "None", "Winter", "Lunch", "Special"
            ),
            new Recipe(
                ...
                30, 5, "16 servings", 282, "Easy", "None", "Spring", "Breakfast", "Regular"
            )
        };
    }
}
